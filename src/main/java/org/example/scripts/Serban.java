...
public class Serban {
    ...
    public static void serbanLoad() throws IOException {
        ...
        Main.logger.info(String.format("Downloaded 20 projects in %dmin%02dsec.", minutes, seconds));
    }

    public static void serbanKPI(GitHub gh, String group) throws IOException {
